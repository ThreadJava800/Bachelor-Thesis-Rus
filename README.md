...
- `parts/` -- директория, в которой лежат отдельные главы будущего документы.
  Данные файлы подключаются в основной документ
    ...
    - `Chapter1.tex` -- реализация механизма сбора диагностики
    - `Chapter2.tex` -- Stratovirt и виртуальное устройство LogDev
    - `Chapter3.tex` -- драйвер UEFI
    - `Chapter4.tex` -- драйвер Windows
