...
\begin{frame}{Цель и задачи}
    ...
    \begin{itemize}
        ...
        \item Обосновать выбор lock-free MPSC-кольцевого буфера.
...
\begin{frame}{Организация кольцевого буфера}
    \begin{table}
        ...
        \begin{tabular}{p{0.25\textwidth} p{0.31\textwidth} p{0.34\textwidth}}
            ...
            Поддерживает только одного писателя \\
            \addlinespace
            ...
            \addlinespace
            MPSC без блокировок &
            Несколько писателей без общей блокировки &
...
\begin{frame}{Lock-free MPSC-буфер}
    \begin{columns}[T]
...
\begin{frame}{Оценка решения}
    \begin{itemize}
        \item Функционально проверяются раннее журналирование UEFI, переход к буферу, несколько источников и единый хронологический журнал.
        \item Производительность оценивается по задержке доставки и стоимости вызова записи.
        \item Сравниваются три варианта: \texttt{virtio-serial}, LogDev lockless и LogDev eBPF-style.
...
\begin{frame}{Результаты измерений}
    \begin{table}
        ...
        \begin{tabular}{lccc}
            \toprule
            Вариант & Потоки & Медиана доставки, мс & Сообщений/с \\
            \midrule
            \texttt{virtio-serial} & 1--16 & 68--70 & 3.4--4.1 тыс. \\
            LogDev lockless & 1--16 & 335--337 & 8.8--20.1 тыс. \\
            LogDev eBPF-style & 1--16 & 799--804 & 12.0--20.4 тыс. \\
            \bottomrule
        \end{tabular}
    \end{table}
    ...
    \begin{itemize}
        ...
        \item Внутри LogDev lockless-буфер даёт выигрыш по доставке примерно в 2.4 раза относительно eBPF-style.
    \end{itemize}
\end{frame}
...
\begin{frame}{Результаты работы}
    \begin{itemize}
        ...
        \item Обоснован и описан lock-free MPSC-кольцевой буфер.
...
\begin{frame}{Заключение}
    \begin{itemize}
        ...
        \item Lock-free MPSC-буфер подходит для нескольких источников диагностических сообщений.
