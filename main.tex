...
\begin{document}
    ...
    \newpage
    \input{parts/Chapter1.tex} %% Обзор существующих решений
    \newpage
    \input{parts/Chapter2.tex} %% Исследовательская часть
    \newpage
    \input{parts/Chapter3.tex} %% Практическая часть: UEFI
    \newpage
    \input{parts/Chapter4.tex} %% Практическая часть: Windows
    \newpage
    \input{parts/Chapter5.tex} %% Оценка полученного решения
    \newpage
